...
function PasswordForm() {
    ...
    const onSubmit = async (values: z.infer<typeof passwordSchema>) => {
        try {
            ...
            toast({ title: "Failed to update password", description: "Please check your current password.", variant: "destructive" });
        }
    };
...
function AppearanceForm() {
    ...
    const handleThemeChange = (theme: typeof themes[0]) => {
        if (typeof window !== 'undefined') {
            ...
            document.documentElement.style.setProperty('--sidebar-primary', theme.accent);
            document.documentElement.style.setProperty('--sidebar-accent', theme.primary);
        }
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex items-center gap-4">
                            <div className="p-4 bg-muted rounded-lg">
                               {logoPreview ? <img src={logoPreview} alt="Logo Preview" className="h-6" /> : <Logo />}
                            </div>
                            <input
                                type="file"
                                ref={logoInputRef}
                            ...
                            />
                            <Button type="button" variant="outline" onClick={handleLogoUploadClick}>Upload New Logo</Button>
                        </div>
                    </div>
                                ...
                                <div key={theme.name}>
                                    ...
                                    >
                                        <div className="flex items-center gap-2">
                                            <div className="h-5 w-5 rounded-full" style={{ backgroundColor: `hsl(${theme.primary})` }} />
                                            <div className="h-5 w-5 rounded-full" style={{ backgroundColor: `hsl(${theme.accent})` }} />
                                        </div>
                                    </button>
